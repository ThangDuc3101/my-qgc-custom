...
Item {
    ...
    readonly property string pauseTitle:                    qsTr("Tạm dừng")
    ...
    readonly property string armMessage:                        qsTr("Khởi động máy bay.")
    readonly property string mvArmMessage:                      qsTr("Khởi động máy bay đã chọn.")
    readonly property string forceArmMessage:                   qsTr("WARNING: This will force arming of the vehicle bypassing any safety checks.")
    readonly property string disarmMessage:                     qsTr("Dừng máy bay.")
    readonly property string mvDisarmMessage:                   qsTr("Dừng máy bay đã chọn.")
